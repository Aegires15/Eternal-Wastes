...
public class PyroisPlanetGenerator extends PlanetGenerator{
    ...
    public void genTile(Vec3 position, TileGen tile){
        ...
        if(tile.floor == Blocks.carbonStone && rand.chance(0.1)){
            tile.block = Blocks.carbonBoulder;
        }

        if(tile.floor == Blocks.ferricStone && rand.chance(0.03)){
            tile.block = Blocks.ferricBoulder;
        }

        if(tile.floor == Blocks.redStone && rand.chance(0.002)){
            tile.block = Blocks.redStoneBoulder;
        }
    }
