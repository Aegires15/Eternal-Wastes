...
public class PyroisPlanetGenerator extends PlanetGenerator{
    ...
    Block[] terrain = {Blocks.ferricStone, Blocks.ferricStone, Blocks.carbonStone, Blocks.ferricStone, Blocks.carbonStone, Blocks.rhyolite, Blocks.rhyolite, Blocks.carbonStone};

    {
        ...
        blend(Blocks.ferricCraters, Blocks.ferricStone, 4);
